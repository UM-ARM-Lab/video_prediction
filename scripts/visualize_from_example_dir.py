...
from video_prediction.visualization import setup_and_run_from_example_folder
...
def main():
    ...
    context_length = 2
    results, has_made_up = setup_and_run_from_example_folder(args.example_dir_path,
                                                             context_length,
                                                             args.checkpoint,
                                                             args.model,
                                                             args.model_hparams)
