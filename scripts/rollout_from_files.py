...
from video_prediction.rollout_utils import setup_and_rollout_from_individual_files, rollout_main
...
def main():
    ...
    context_length = 2
    results = setup_and_rollout_from_individual_files(args.images,
                                                      args.states,
