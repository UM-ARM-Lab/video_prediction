...
class UnityClothDataset(VideoDataset):
    def __init__(self, *args, **kwargs):
        super(UnityClothDataset, self).__init__(*args, **kwargs)
    ...
    def parser(self, serialized_example):
        state_like_seqs, action_like_seqs = super(UnityClothDataset, self).parser(serialized_example)
